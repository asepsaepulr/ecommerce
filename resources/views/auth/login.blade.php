...
<head>
  ...
  <title>Ecommerce||Aldohc LOGIN</title>
...
<body background="{{ asset('/img/demo/1.jpg') }}" alt="">
      ...
      <div class="container-fluid  auth-page">
        <div class="align-items-center auth theme-one">
          <div class="row w-100">
            ...
            <img src="{{ asset('/img/demo/3.png') }}" width="600px" height="500px">
            <div class="col-lg-4 mx-auto">
              <h2 style="text-align: center ;">ECOMMERCE || ALDOHC</h2>
              ...
              <p class="footer-text text-center" style="margin-top: 20px;color: white">Copyright © {{date('Y')}} ECOMMERCE||ALDOHC - All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
