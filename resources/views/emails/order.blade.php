...
<body>
	<table width='700px'>
		<tr><td>&nbsp;</td></tr>
		<tr><td><img src="{{ asset('/frontend/img/team/aldohc.png') }}"></td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>Hello {{ $name }},</td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>Thank you for shopping with us. Your order details are as below :-</td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr><td>Code Order: {{ $order_id }}</td></tr>
		<tr><td>&nbsp;</td></tr>
		<tr>
			<center>
				<u><h2>Aldohc Distro</h2></u></center>
			<td>
			<table width='95%' cellpadding="5" cellspacing="5" bgcolor="#f7f4f4">
				...
				@endforeach
				<tr>
					<td colspan="5" align="right">Grand Total</td><td><?php echo 'Rp.'.number_format($productDetails['grand_total'])?></td>
				</tr>
			</table>
		</td></tr>
		<tr><td>
		...
		<tr><td>&nbsp;</td></tr>
		<tr><td>For any enquiries, you can contact us at <a href="mailto:info@ecom-web">asepsaepulr88@gmail.com</a></td></tr>
		<tr><td>&nbsp;</td></tr>
